 ...
 namespace Week1Practice
 {
     class Program
     {
         public static object numLetters { get; set; }

         public static string MyName { get; set; }

         public static string numItems { get; set; }
...

         {
          ...
          //string MyName = "Brandy";
           ...
           //    numName = i + 1;
            ...
            List<string> productList = new List<string>(k);
                ...
                for (int n = 0; n < item.Length; n++)
  {
         ...
         static void DoubleIt(int number)
       {
         ...
         static void SuperLoop(int startNum, int endNum, int increment)
         {
             ...
             Console.WriteLine("I am looping from " + startNum + " to " + endNum + ", incrementing " + increment + " each time");
             while (i <= endNum)
             {
                 Console.WriteLine(i);
                 counter = i + increment;
             ...
             Console.WriteLine("That loop was crazy, we looped " + counter + " times");
         }
